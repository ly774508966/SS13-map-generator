...
namespace SS13MapGen_Shared
{
    ...
    public class BYONDInstance
    {
        ...
        /// </summary>
        public string typePath = "/turf"; //might not need to make this public, we'll see though
        ...
        /// </summary>
        public Dictionary<string, string> differentVars = new Dictionary<string, string>(); //Again, not sure if needs to be public
        ...
        /// </summary>
        public string special = "NONE"; //I can place these publicity comments all damn day

        /// <summary>
        /// Name, duh, this is what it shows up as in the instance browser
        /// </summary>
        public string name = "Horrible glitch"; //See line 29
    }
}
